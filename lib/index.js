...
NDoc.prototype.toHTML = function (options) {
  ...
  function signature(obj, sig, type, id) {
    ...
    else if (type == "event")
    {
      ...
      r = '<span class="eventObjName">' + obj.id.substring(0, finalDot) +'</span><span class="eventListenerStart">' + '.on(</span>\"<span id="' + id + '" class="member-name methodClicker eventMember">' + eventName + '</span>\"'; 
    }
